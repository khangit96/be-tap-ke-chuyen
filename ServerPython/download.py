import urllib3.request   
                                             # needed for functions,classed for opening urls.
url ="https://s3-us-west-2.amazonaws.com/khangit/musice1.mp3";
 
usock = urllib3.request.urlopen(url)                                  #function for opening desired url
